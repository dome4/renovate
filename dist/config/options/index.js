...
const options = [
    ...
    {
        name: 'extends',
        description: 'Configuration presets to use or extend. Note: This config option does not work if you use a `config.js` file.',
        stage: 'package',
        type: 'array',
        subType: 'string',
        allowString: true,
    ...
    {
        name: 'printConfig',
        description: 'If enabled, Renovate logs the fullly resolved config for each repo, plus the fully resolved presets.',
        type: 'boolean',
        globalOnly: true,
        default: false,
    },
